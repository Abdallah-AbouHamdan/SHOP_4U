        ...
        <div className='bg-[#ffffff] pb-16 pt-8 min-h-screen'>
            ...
            <div className="mx-auto w-11/12 max-w-6xl">
                {favoriteProducts.length === 0 ? (
                    <div className="rounded-3xl border border-dashed border-slate-200 bg-white/80 p-10 text-center text-slate-500 shadow-sm">
                        You haven&apos;t added any favorites yet. Tap the heart on a product card
                        or inside the product details to save it for later.
                    </div>
                ) : (
